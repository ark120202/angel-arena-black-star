...
function Precache( context )
	...
	PrecacheUnitByNameSync("npc_dota_boss_earth", context)
	PrecacheUnitByNameSync("npc_dota_boss_wind", context)
	PrecacheUnitByNameSync("npc_dota_boss_primal", context)
