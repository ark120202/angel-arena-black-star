...
function modifier_item_book_of_the_guardian_aura:IsPurgable() return false end
...
function modifier_item_book_of_the_guardian_blast:GetEffectName()
	return "particles/econ/events/ti7/shivas_guard_slow.vpcf"
end

function modifier_item_book_of_the_guardian_blast:GetEffectAttachType()
