...
function modifier_sai_rage_of_pain:GetModifierPreAttack_CriticalStrike(keys)
	...
	if RollPercentage(ability:GetSpecialValueFor("crit_chance_pct") + ability:GetSpecialValueFor("crit_chance_per_stack_pct") * stacks) then
		return 100 + ability:GetSpecialValueFor("crit_mult_pre_stack_pct") * stacks
	end
end
