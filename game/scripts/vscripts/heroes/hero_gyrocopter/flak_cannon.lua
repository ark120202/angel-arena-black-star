...
LinkLuaModifier("modifier_gyrocopter_flak_cannon_arena", "heroes/hero_gyrocopter/flak_cannon.lua", LUA_MODIFIER_MOTION_NONE)
modifier_gyrocopter_flak_cannon_arena = {
...
LinkLuaModifier("modifier_gyrocopter_flak_cannon_arena_scepter", "heroes/hero_gyrocopter/flak_cannon.lua", LUA_MODIFIER_MOTION_NONE)
