LinkLuaModifier("modifier_weather_sunny_aura_effect", "modules/weather/modifiers/modifier_weather_sunny", LUA_MODIFIER_MOTION_NONE)
...
modifier_weather_sunny = class({
	...
	GetModifierAura    = function() return "modifier_weather_sunny_aura_effect" end,
