...
CREEP_UPGRADE_FUNCTIONS = {
	...
	easy = {
		[0]     = { 5,          20,         1,          1,          0.8,        1.0,        18          },
		[5]     = { 5,          20,         1,          1,          1,          0,          20          },
		[10]    = { 5,          20,         2,          2,          1.0,        0.5,        25          },
		[15]    = { 6,          25,         3,          2,          1.0,        0.5,        30          },
		[20]    = { 8,          30,         4,          0.4,        1.3,        0.5,        50          },
	...
	medium = {
		[0]     = { 3,          25,         2,          0,          2,          0,          5           },
		[5]     = { 3,          30,         2,          0,          2,          0,          10          },
		[10]    = { 3,          50,         3,          0.2,        2,          0.2,        15          },
		[15]    = { 4,          60,         4,          0.3,        2,          0.2,        30          },
		[20]    = { 5,          70,         5,          0.3,        2,          0.2,        40          },
