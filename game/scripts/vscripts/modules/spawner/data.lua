...
CREEP_UPGRADE_FUNCTIONS = {
	...
	medium =    {
		[0]     = { 2,          25,         2,          0,          2,          0,          12          },
		[5]     = { 3,          30,         3.0,        0,          2,          0,          18          },
		[10]    = { 6,          200,        5,          0.9,        2,          0.5,        23          },
		[20]    = { 12,         248,        9,          1.5,        2,          0.6,        30          },
		[30]    = { 24,         400,        15,         0.85,       2,          0.7,        100         },
		[60]    = { 38,         500,        30,         0.90,       2,          0.8,        150         },
	},
	hard = {
		[0]     = { 5,         55,         2.3,        2,          2,          0.5,        30          },
		[10]    = { 6,         200,        6,          3,          2,          1,          60          },
		[15]    = { 8,         350,        8,         3,          2,          1.1,          120         },
		[20]    = { 10,        450,        11,         5,          2,          1.2,          120         },
		[30]    = { 30,        550,        20,         6,          2,          1.3,          150         },
		[60]    = { 50,        800,        50,         7,         2,          1.5,          250         },
	},
}
