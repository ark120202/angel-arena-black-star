...
CREEP_UPGRADE_FUNCTIONS = {
	...
	easy = {
		[0]     = { 5,          33,         6,          5,          0.8,        1.0,        18          },
		[5]     = { 10,         55,         6,          1,          1,          0,          20          },
		[10]    = { 10,         35,         5,          5,          1.0,        1.0,        25          },
	...
	medium =    {
		[0]     = { 5,          55,         5.0,        1,          2,          0,          12          },
		[5]     = { 5,          55,         6.0,        1,          2,          0.5,        18          },
		[10]    = { 9,          135,        7,          0.9,        2,          0.8,        23          },
		[20]    = { 25,         248,        9,          1.5,        2,          0.6,        30          },
		[30]    = { 35,         400,        20,         0.85,       2,          0.8,        100         },
		[60]    = { 50,         500,        25,         0.90,       2,          0.8,        150         },
	},
	hard = {
		[0]     = { 1.1,        55,         2.3,        5,          2,          1,          30          },
		[10]    = { 13,         115,        5,          3,          2,          2,          60          },
		[20]    = { 35,         350,        15,         5,          2,          3,          120         },
		[30]    = { 100,        750,        25,         7,          2,          4,          150         },
		[60]    = { 160,        1500,       50,         10,         2,          4,          250         },
	},
}
