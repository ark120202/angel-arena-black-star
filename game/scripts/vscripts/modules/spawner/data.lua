...
CREEP_UPGRADE_FUNCTIONS = {
	...
	easy = {
		...
		[5]     = { 6,          30,         3,          1,          1,          0,          20          },
		[10]    = { 6,          35,         5,          5,          1.0,        1.0,        25          },
		[20]    = { 7,          35,         6,          0.4,        1.3,        1.0,        70          },
		[30]    = { 15,         85,         10,         0.45,       0.45,       1.0,        140         },
		[60]    = { 35,         120.5,      20,         0.5,        0.5,        0.5,        200         },
	},
	medium = {
		[0]     = { 3,          25,         2,          0,          2,          0,          5           },
		[5]     = { 4,          30,         3.0,        0,          2,          0,          10          },
		[10]    = { 5,          50,         5,          0.2,        2,          0.5,        15          },
		[20]    = { 6,          100,        7,          0.3,        2,          0.6,        30          },
		[30]    = { 12,         200,        12,         0.4,        2,          0.7,        100         },
		[60]    = { 40,         350,        30,         0.5,        2,          0.8,        150         },
	},
	hard = {
