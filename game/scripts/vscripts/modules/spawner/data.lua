...
CREEP_UPGRADE_FUNCTIONS = {
	...
	easy = {
		...
		[5]     = { 5,          30,         2,          1,          1,          0,          20          },
		[10]    = { 5,          35,         3,          2,          1.0,        0.5,        25          },
		[15]    = { 6,          40,         4,          2,          1.0,        0.5,        25          },
	...
	medium = {
		[0]     = { 3,          25,         2,          0,          2,          0,          5           },
		[5]     = { 3,          30,         3,          0,          2,          0,          10          },
		[10]    = { 4,          50,         5,          0.2,        2,          0.5,        15          },
		[15]    = { 5,          60,         7,          0.3,        2,          0.6,        30          },
		[20]    = { 6,          100,        7,          0.3,        2,          0.6,        30          },
		[30]    = { 12,         200,        12,         0.4,        2,          0.7,        200         },
		[40]    = { 20,         275,        15,         0.4,        2,          0.7,        300         },
		[60]    = { 40,         350,        30,         0.5,        2,          0.8,        500         },
	},
	hard = {
		[0]     = { 4,          55,         2.3,        0,          2,          0.5,        15          },
		[10]    = { 5,          70,         6,          0.5,        2,          0.6,        20          },
		[15]    = { 6,          100,        7,          0.5,        2,          0.7,        30          },
		[20]    = { 7,          150,        8,          0.6,        2,          0.8,        50          },
		[30]    = { 20,         250,        15,         0.7,        2,          0.9,        250         },
		[40]    = { 30,         350,        20,         0.7,        2,          0.9,        350         },
		[60]    = { 60,         500,        40,         0.8,        2,          1.0,        600         },
	},
}
