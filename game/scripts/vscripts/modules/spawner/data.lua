...
CREEP_UPGRADE_FUNCTIONS = {
	...
	medium = {
		[0]     = { 2,          25,         2,          0,          2,          0,          12          },
		[5]     = { 3,          30,         3.0,        0,          2,          0,          18          },
		[10]    = { 6,          150,        5,          0.2,        2,          0.5,        23          },
		[20]    = { 12,         200,        9,          0.3,        2,          0.6,        30          },
		[30]    = { 24,         250,        15,         0.4,        2,          0.7,        100         },
		[60]    = { 45,         350,        30,         0.5,        2,          0.8,        150         },
	},
	hard = {
		[0]     = { 5,          55,          2.3,       0,          2,          0.5,        30          },
		[10]    = { 6,          100,         6,         0.5,        2,          0.6,        60          },
		[15]    = { 8,          150,         7,         0.5,        2,          0.7,        120         },
		[20]    = { 10,         250,         8,         0.6,        2,          0.8,        120         },
		[30]    = { 30,         350,         15,        0.7,        2,          0.9,        150         },
		[60]    = { 60,         500,         40,        0.8,        2,          1.0,        250         },
	},
}
