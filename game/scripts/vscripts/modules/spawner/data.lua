...
CREEP_UPGRADE_FUNCTIONS = {
	...
	easy = {
		[0]     = { 15,         33,         1.9,        5,          0.8,        1.0,        15          },
		[10]    = { 4,          35,         5,          5,          1.0,        1.5,        25          },
		[20]    = { 3,          35,         12,         0.4,        1.3,        1,          70          },
		[30]    = { 2,          85,         13,         0.45,       0.45,       0.45,       140         },
		[60]    = { 3,          120.5,      20,         0.5,        0.5,        0.5,        200         },
	},
	medium =    {
		[0]     = { 10,         55,         5.0,        2,          25,         0,          8           },
		[5]     = { 10,         55,         7.0,        2,          25,         0,          8           },
		[10]    = { 13,         135,        9,          0.9,        25,         1.5,        16          },
		[20]    = { 30,         248,        13,         1.5,        25,         2,          30          },
		[30]    = { 40,         400,        20,         0.85,       25,         3,          100         },
		[60]    = { 60,         500,        25,         0.90,       25,         4,          150         },
	},
	hard = {
		[0]     = { 1.1,        55,         2.3,        10,         65,         1,          20          },
		[10]    = { 13,         115,        11,         1,          25,         2,          60          },
		[20]    = { 40,         350,        25,         1,          25,         3,          120         },
		[30]    = { 110,        750,        25,         1,          25,         4,          150         },
		[60]    = { 180,        1500,       50,         2,          25,         4,          250         },
	},
}
