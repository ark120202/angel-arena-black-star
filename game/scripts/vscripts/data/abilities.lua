...
MEEPO_SHARED_ITEMS = {
	...
	item_dagon_1_arena = true,
	item_dagon_2_arena = true,
	item_dagon_3_arena = true,
	item_dagon_4_arena = true,
	item_dagon_5_arena = true,
	item_enchanted_dagon_1_arena = true,
	item_enchanted_dagon_2_arena = true,
	item_enchanted_dagon_3_arena = true,
	item_enchanted_dagon_4_arena = true,
	item_enchanted_dagon_5_arena = true,
	item_sunray_dagon_1 = true,
	item_sunray_dagon_2 = true,
	item_sunray_dagon_3 = true,
	item_sunray_dagon_4 = true,
	item_sunray_dagon_5 = true,
}
