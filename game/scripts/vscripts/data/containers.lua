...
DROP_TABLE = {
	["npc_arena_boss_heaven"] = {
		...
		{ Item = "item_phantom_bone", DropChance = 10, },
		{ Item = "item_moon_dust", DropChance = 20, },
		{ Item = "item_cursed_eye", DropChance = 7, },
		{ Item = "item_fallen_star", DropChance = 8, },
		{ Item = "item_demons_paw", DropChance = 9, },

		{ Item = "item_shard_primal_medium", DropChance = 20, },
		{ Item = "item_shard_str_large", DropChance = 22, },
		{ Item = "item_shard_agi_large", DropChance = 22, },
